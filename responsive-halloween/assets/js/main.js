...
// sr.reveal(`.category__img , .items__card`, { interval: 100 });
// sr.reveal(`.about_img, .about__data', .footer__tree-2`, { origin: "left" });
...
ScrollReveal().reveal(`.home__tree-1`, { origin: "left", delay: 800 });
ScrollReveal().reveal(`.home__tree-2`, { origin: "right", delay: 800 });
ScrollReveal().reveal(`.home__img`, { delay: 800 });
ScrollReveal().reveal(`.category__img , .items__card`, { interval: 100 });
ScrollReveal().reveal(`.about_img, .about__data', .footer__tree-2`, {
  origin: "left",
});
